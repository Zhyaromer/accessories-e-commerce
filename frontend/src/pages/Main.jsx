...
import {  Instagram, Facebook, Twitter, ChevronLeft } from 'lucide-react';
      ...
      <div className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div dir='rtl' className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { name: "کاتژمێر", count: "24 پارچە", image: "https://www.engraversguild.co.uk/wp-content/uploads/2022/11/nurse-watch-mq-landscape-scaled.jpg" },
              { name: "ملوانکە", count: "36 پارچە", image: "https://th.bing.com/th/id/R.a16c5c636f811f25366b6b7d725a307e?rik=VpZ6iVflPqRuHg&riu=http%3a%2f%2fwww.wellfield.th.com%2fimgadmins%2fgallery%2f139866522410K-06.jpg&ehk=78hwBRTSbBHsO%2fePiASiob9m8rKWJIVxcT1p1PPTAhA%3d&risl=&pid=ImgRaw&r=0" },
              { name: "دەستبەند", count: "18 پارچە", image: "https://wallpapercave.com/wp/wp2487315.jpg" },
            ].map((category, index) => (
              <div key={index} className="relative rounded-lg overflow-hidden group">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-6">
                  ...
                  <a href="#" className="text-white bg-white/20 hover:bg-white/30 backdrop-blur-sm px-4 py-2 rounded-md inline-block w-max transition-colors">
                    بینینی زیاتر
                  </a>
                </div>
              </div>
